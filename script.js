...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const questions = [
...

        {
            ...
            answers: [
                "\\ 'Second backslash used to escape backslash'",
                "/",
                "|",
                "!"
            ],
...
// Track which question te user is currently viewing
...
function checkAnswer(index){
    ...
    // Get reference to the feedbacl element
    ...
    if(isCorrect){
        // for correct answers
        feedback.innerHTML = `<strong>Correct!</strong>The answer is ${correctLabel}) ${correctAnswer}
        ...
        if(index === -1){
            ...
            feedback.innerHTML = `<strong>Time's up!</strong> The correct answer is ${correctLabel}) ${correctAnswer} <br> ${questions[currentQuestion].feedback}`
        }else{
